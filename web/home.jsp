            ...
            <nav class="navbar-default navbar-side" role="navigation">
                <div class="sidebar-collapse">
                    <ul class="nav" id="main-menu">
                        ...
                        <li>
                            <a class="#"  href="index.html"><i class="fa fa-dashboard fa-3x"></i> Trang chủ</a>
                        </li>
                        <li>
                            <a href="manageproduct"><i class="fa fa-desktop fa-3x"></i> Quản Lý Sản Phẩm</a>
                        </li>
                        <li>
                            <a  href="#"><i class="fa fa-qrcode fa-3x"></i> </a>
                        </li>
                        <li  >
                            <a   href="#"><i class="fa fa-bar-chart-o fa-3x"></i> Morris Charts</a>
                        </li>	
                        <li  >
                            <a  href="accountManagerment.jsp"><i class="fa fa-table fa-3x"></i> Quản Lý Tài Khoản</a>
                        </li>
                        <li  >
